...
static int SetTilingData(Irfft1DfftTilingData &tiling, int64_t fftN, int32_t isInverse,
                                         ...
                                         uint32_t batches, int isForward, void *stream)
{
    ...
    CHECK_ACL(aclrtMemcpy(dev_fft_matrix, fftMatrixSize, allfftMatrices.data(), fftMatrixSize, ACL_MEMCPY_HOST_TO_DEVICE));
