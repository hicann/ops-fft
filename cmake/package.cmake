...
function(pack_built_in)
    message(STATUS "============================================")
    message(STATUS "Packing built-in ops_fft package...")
    message(STATUS "  SOC: ${SOC_VERSION}")
    message(STATUS "  Architecture: ${ARCH}")
    message(STATUS "============================================")

    # 1. 安装脚本文件 (与 ops-math 保持一致)
    set(script_prefix ${CMAKE_SOURCE_DIR}/scripts/package/ops_fft/scripts)
    install(DIRECTORY ${script_prefix}/
        DESTINATION share/info/ops_fft/script
        FILE_PERMISSIONS
    ...
    # 4. 安装版本信息
    install(FILES ${CMAKE_BINARY_DIR}/version.ops_fft.info
        DESTINATION share/info/ops_fft
        RENAME version.info
    )

    # 5. 安装配置文件和脚本
    install(FILES ${CONF_FILES}
        DESTINATION ops_fft/conf
        OPTIONAL
    )
    ...
    # 7. CPack 配置
    set(CPACK_PACKAGE_NAME "cann-${SOC_VERSION}-ops-fft")
